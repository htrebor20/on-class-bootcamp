...
import com.pragma.onclass.adapters.driving.http.dto.response.CapacityTechnologyResponse;
...
public interface ITechnologyRequestMapper {
    ...
    List<CapacityTechnologyResponse> toTechnologyResponseListWithoutDesc(List<Technology> technologies);
}
